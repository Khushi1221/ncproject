...
<html>
      ...
      <body>
            ...
            <div class="container login_form" style="padding-bottom:33px">
                  <div class="row">
                        <div class="col-xs-6 col-xs-offset-3">
                              <div class="panel panel-primary">
                                    ...
                                    <div class="panel-body">
                                          <p class="text-warning" style="font-size: 20px">Please enter the security code to proceed...</p>
                                          <form method = "post" action = "admin_access_script.php">
                                           <div class="form-group">
                                                 ...
                                                 <i class="bi bi-eye-slash" id="togglePassword1"></i>
                                                      ...
                                                      <input type="submit" value="Login" class="btn btn-primary" style="font-size: 18px">
                                           </div>
                                          </form>
                                    </div>
                              </div>
