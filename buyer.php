...
<form method="POST" action="buyer.php">
            ...
            <h1 style="padding-top:52px">Welcome to our Community!!!</h1>
...
<?php
				...
				if(isset($_POST['search']))
				{
					...
					if($loc!=0)
					{
						echo '<div style="margin-left:80px; font-size:16px; margin-top:10px">'."Showing results for pincode : ".$loc.'</div>';
