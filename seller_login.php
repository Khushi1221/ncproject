                        ...
                        <div class="col-xs-6 col-xs-offset-3">
                              <div class="panel panel-primary">
                                    ...
                                    <div class="panel-body">
                                          ...
                                          <form method = "post" action = "seller_login_script.php">
                                           <div class="form-group">
                                                 ...
                                                 <i class="bi bi-eye-slash" id="togglePassword1"></i>
													  ...
													  <p style="margin-top:-10px; margin-left:5px"><a href="sellerresetpwd.php">Forgot Password? Reset it.</a><p><br>
                                    ...
                                    <div class="panel-footer" style="margin:10px 0 0 0">
                                          <p style="margin:3px 0 0 0; font-size: 16px">Don't have an account? <a href="seller_signup.php">Register</a></p>
                                    </div>
                              </div>
                        </div>
                  </div>
