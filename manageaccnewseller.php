...
<html>
	  ...
	  <body>
			...
			<div class="main">
			<a href="seller.php" style="margin-left:-50px">Go Back</a>
			<!-- CHANGE PASSWORD -->
			<div class="container" id="CPWD" style="margin-bottom: 111px">
				...
				<div class="col-xs-6 col-xs-offset-3" style="margin-left: -15px; padding-top: 10px">
                    <form method = "post" action = "manageacc_script_pwdseller.php">
                    <div class="form-group">
						...
						<p style="margin-top:-10px; margin-left:5px"><a href="sellerresetpwd.php">Forgot Password? Reset it.</a><p>
			...
			<div class="container" id="CUN" style="display:none; margin-bottom: 137px">
				...
				<div class="col-xs-6 col-xs-offset-3" style="margin-left: -15px; padding-top: 10px">
                    <form method = "post" action = "manageacc_script_unameseller.php">
                    <div class="form-group">
...
function deleteAccount() 
   {
	   var r = confirm("Are you sure you want to Delete Account?");
		...
		if (r == true)
		{
			window.location.replace("http://localhost:8081/test/delaccseller.php");
